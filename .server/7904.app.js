...
;// CONCATENATED MODULE: ./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!./node_modules/@vuepress/bundler-webpack/lib/build/ssr/vuepressLoader.js!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[1]!./docs/.vuepress/.temp/pages/feature/image.html.vue?vue&type=template&id=4512cbc4
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>template</span><span class="token punctuation">&gt;</span></span>
  ...
  }">des</th></tr></thead><tbody><tr><td>isShowTopImg</td><td style="${
    (0,server_renderer.ssrRenderStyle)({"text-align":"center"})
  }">是否展示顶部图片</td></tr><tr><td>isShowHeadLine</td><td style="${
    (0,server_renderer.ssrRenderStyle)({"text-align":"center"})
  }">是否展示标题，针对于文章页面</td></tr><tr><td>headLine</td><td style="${
    (0,server_renderer.ssrRenderStyle)({"text-align":"center"})
  }">标题名称</td></tr></tbody></table><h2 id="额外使用组件" tabindex="-1"><a class="header-anchor" href="#额外使用组件" aria-hidden="true">#</a> 额外使用组件</h2><p>如需在自己需要的地方使用，可以通过下面方式，传入对应值就行</p><div class="language-vue ext-vue line-numbers-mode"><pre class="language-vue"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>top-image</span> <span class="token attr-name">:is-show-top-img</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>...<span class="token punctuation">&quot;</span></span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><h2 id="海报功能配置" tabindex="-1"><a class="header-anchor" href="#海报功能配置" aria-hidden="true">#</a> 海报功能配置</h2><p>`)
  _push((0,server_renderer.ssrRenderComponent)(_component_RouterLink, { to: "/feature/poster.html" }, {
    default: (0,external_vue_.withCtx)((_, _push, _parent, _scopeId) => {
      if (_push) {
        _push(`海报功能配置`)
      } else {
        return [
          (0,external_vue_.createTextVNode)("海报功能配置")
        ]
      }
    }),
    _: 1
...
;// CONCATENATED MODULE: ./docs/.vuepress/.temp/pages/feature/image.html.vue?vue&type=template&id=4512cbc4

// EXTERNAL MODULE: ./node_modules/vue-loader/dist/exportHelper.js
var exportHelper = __webpack_require__(83744);
;// CONCATENATED MODULE: ./docs/.vuepress/.temp/pages/feature/image.html.vue
...
/* harmony default export */ const image_html = (__exports__);

/***/ })

};
;
//# sourceMappingURL=7904.app.js.map