...
;// CONCATENATED MODULE: ./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!./node_modules/@vuepress/bundler-webpack/lib/build/ssr/vuepressLoader.js!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[1]!./docs/.vuepress/.temp/pages/feature/social.html.vue?vue&type=template&id=f5992be0
...
function ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<!--[--><h1 id="社交" tabindex="-1"><a class="header-anchor" href="#社交" aria-hidden="true">#</a> 社交</h1><p><img src="https://ooszy.cco.vin/img/blog-public/ljz.gif" alt="image-20211011151211549" originSrc="https://ooszy.cco.vin/img/blog-note/image-20211011151211549.png?x-oss-process=style/pictureProcess1" data="aurora"></p><img src="https://ooszy.cco.vin/img/blog-note/image-20211011151225054.png?x-oss-process=style/pictureProcess1" alt="image-20211011151225054" style="${(0,server_renderer.ssrRenderStyle)({"zoom":"50%"})}"><blockquote><p>组件位置</p><p>docs/.vuepress/theme/lib/client/components/child/side/HomeSidebarSocialItem.vue</p></blockquote><p>其中，手机端至多显示7个(<code>首页</code>)，侧边栏等不受影响，PC端首页至多只能显示19个，如果超过，则不会显示，侧边栏不受影响</p><h2 id="配置" tabindex="-1"><a class="header-anchor" href="#配置" aria-hidden="true">#</a> 配置</h2><div class="language-javascript ext-js line-numbers-mode"><pre class="language-javascript"><code>module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
...
module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br></div></div><img src="https://ooszy.cco.vin/img/blog-note/image-20211011155752690.png?x-oss-process=style/pictureProcess1" alt="image-20211011155752690" style="${(0,server_renderer.ssrRenderStyle)({"zoom":"50%"})}"><p><img src="https://ooszy.cco.vin/img/blog-public/ljz.gif" alt="image-20211011155915438" originSrc="https://ooszy.cco.vin/img/blog-note/image-20211011155915438.png?x-oss-process=style/pictureProcess1" data="aurora"></p><h2 id="评论配置" tabindex="-1"><a class="header-anchor" href="#评论配置" aria-hidden="true">#</a> 评论配置</h2><p>`)
  _push((0,server_renderer.ssrRenderComponent)(_component_RouterLink, { to: "/comment/" }, {
    default: (0,external_vue_.withCtx)((_, _push, _parent, _scopeId) => {
      if (_push) {
        ...
        return [
          (0,external_vue_.createTextVNode)("评论配置")
        ]
      }
    }),
    _: 1
...
;// CONCATENATED MODULE: ./docs/.vuepress/.temp/pages/feature/social.html.vue?vue&type=template&id=f5992be0
